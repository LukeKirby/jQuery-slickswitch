...
* animationDuration – How long the slider switch should be animated for. Use 0 to disable animation. Note: this option was previously named useAnimation and took a boolean value but has been changed to allow someone to specify the duration that the slider should be animated for when changing state.
